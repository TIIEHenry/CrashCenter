...
public class PrefManager {
    public static final String PACKAGE_NAME = "nota.android.crash.xp.app";
    public static final String PREF_NAME = "crash";
    public static final String PREF_PACKAGE_LIST = "package_list";
